...
const GameFrame = ({ gamePath, title }) => {
  ...
  return (
    <div
      className="w-full h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 flex flex-col overflow-hidden"
      ...
      >
        <div>
          ...
          <p className="text-gray-400 text-xs md:text-sm">
            Enjoy this amazing game experience
          </p>
        </div>
        <a
          href="/"
        ...
        {isLoading && (
          <div className="absolute inset-0 flex items-center justify-center bg-black z-10">
            <div className="text-center">
              ...
              <p className="text-cyan-400 font-semibold">Loading {title}...</p>
            </div>
          </div>
        )}
        {hasError && (
